export default function StudentAttendanceTour() {
      ...
      <div className="mt-[9vh] flex h-[74vh] gap-[4vw]">
          ...
          <div className="mt-[4vh] flex flex-col gap-[2.6vh]">
            <div className="flex items-start gap-[1.2vw]">
              ...
              <p className="font-body text-[2vw] leading-[1.3]">
                The same kiosk scan marks attendance instantly — present, tardy, or excused — with no separate roll call.
              </p>
            </div>
            <div className="flex items-start gap-[1.2vw]">
              <div className="mt-[0.7vh] h-[1vw] w-[1vw] rounded-full bg-[#F2A33C] shrink-0" />
              <p className="font-body text-[2vw] leading-[1.3]">
                Positive behavior points post automatically, feeding the PBIS House Cup the whole school can see.
              </p>
            </div>
            <div className="flex items-start gap-[1.2vw]">
              <div className="mt-[0.7vh] h-[1vw] w-[1vw] rounded-full bg-[#F2A33C] shrink-0" />
              <p className="font-body text-[2vw] leading-[1.3]">
                Prospective families meet the school first through a public, bilingual tour page — shown at right.
              </p>
            </div>
          </div>

          <div className="mt-[4vh] inline-flex w-fit items-center gap-[0.8vw] rounded-[0.6vw] bg-[#0B1F33] px-[1.4vw] py-[1.1vh]">
            <span className="font-body text-[1.5vw] font-bold tracking-[0.18em] uppercase text-[#2DD4BF]">Public page</span>
            <span className="font-body text-[1.5vw] text-[#EAF2F0]">D.S. Parrott Middle — &ldquo;Where Leaders Are Unleashed&rdquo;</span>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center">
          <div className="w-full overflow-hidden rounded-[1vw] border border-[#0B1F33]/12 bg-white shadow-[0_2vh_4vh_rgba(11,31,51,0.14)]">
            <img
              src={`${base}shots/tour.jpg`}
              alt="D.S. Parrott Middle School public tour page"
