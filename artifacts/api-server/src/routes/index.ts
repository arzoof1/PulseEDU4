...
import hallPassResearchRouter from "./hallPassResearch";
...
import starterListsRouter from "./starterLists";
...
import coverageReportRouter from "./coverageReport";
...
import behaviorSupportsRouter from "./behaviorSupports";
...
router.use(hallPassResearchRouter);
...
router.use(coverageReportRouter);
...
router.use(behaviorSupportsRouter);
