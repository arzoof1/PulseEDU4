  ...
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-[#0C0F1A] text-white font-[Inter,sans-serif]">
      ...
      <div className="absolute top-[5vh] right-[5vw] flex items-center gap-[1vw]">
        ...
        <div className="text-[1vw] text-white/50">10 / 20</div>
      </div>

      <div className="relative z-10 h-full grid grid-cols-2 gap-[3vw] px-[7vw] py-[14vh] items-center">
        <div>
          <div className="text-[1vw] font-medium tracking-widest text-[#4F7FFF] uppercase mb-[1.5vh]">Module 08 · Culture</div>
          <h1 className="text-[5vw] font-extrabold leading-[1] tracking-[-0.03em] mb-[3vh]">Displays</h1>
          <p className="text-[1.5vw] font-light text-white/70 leading-[1.5] max-w-[35vw]">Wall-mounted signage in hallways, the cafeteria, and the front office — leaderboards, schedules, and shout-outs that update live.</p>
        </div>
        <div className="flex flex-col gap-[2vh]">
          <div className="bg-[#131726] border border-white/10 rounded-[1vw] p-[2vw]">
            ...
            <div className="text-[1.1vw] text-white/80 leading-[1.55]">Open a Display URL on any screen and it auto-rotates through House standings, points leaderboards, the bell schedule, and recent recognitions.</div>
          </div>
          <div className="bg-[#131726] border border-white/10 rounded-[1vw] p-[2vw]">
            <div className="text-[0.85vw] font-semibold tracking-widest text-[#4F7FFF] uppercase mb-[1vh]">Who uses it</div>
            <div className="text-[1.1vw] text-white/80 leading-[1.55]">Admin sets it up · Students and staff see it everywhere they walk · No login needed on the display itself</div>
          </div>
          <div className="bg-[#131726] border border-white/10 rounded-[1vw] p-[2vw]">
            <div className="text-[0.85vw] font-semibold tracking-widest text-[#4F7FFF] uppercase mb-[1vh]">How it works</div>
            <div className="text-[1.1vw] text-white/80 leading-[1.55]">Per-location URL · Pick which panels rotate · Brand colors and school logo · No extra hardware beyond the screen and a browser</div>
          </div>
        </div>
      </div>
    </div>
