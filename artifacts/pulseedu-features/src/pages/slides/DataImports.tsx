  ...
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-[#0C0F1A] text-white font-[Inter,sans-serif]">
      ...
      <div className="absolute top-[5vh] right-[5vw] flex items-center gap-[1vw]">
        ...
        <div className="text-[1vw] text-white/50">17 / 20</div>
      </div>

      <div className="relative z-10 h-full grid grid-cols-2 gap-[3vw] px-[7vw] py-[14vh] items-center">
        <div>
          <div className="text-[1vw] font-medium tracking-widest text-[#7C6BF0] uppercase mb-[1.5vh]">Module 15 · Integrations</div>
          <h1 className="text-[5vw] font-extrabold leading-[1] tracking-[-0.03em] mb-[3vh]">Data Imports</h1>
          <p className="text-[1.5vw] font-light text-white/70 leading-[1.5] max-w-[35vw]">A nightly CSV from your SIS keeps rosters, courses, grades, and attendance in sync — no manual upkeep.</p>
        </div>
        <div className="flex flex-col gap-[2vh]">
          <div className="bg-[#131726] border border-white/10 rounded-[1vw] p-[2vw]">
            ...
            <div className="text-[1.1vw] text-white/80 leading-[1.55]">Picks up overnight CSV exports from PowerSchool, Infinite Campus, Skyward, and similar SIS platforms; reconciles changes by ID.</div>
          </div>
          <div className="bg-[#131726] border border-white/10 rounded-[1vw] p-[2vw]">
            <div className="text-[0.85vw] font-semibold tracking-widest text-[#7C6BF0] uppercase mb-[1vh]">Who uses it</div>
            <div className="text-[1.1vw] text-white/80 leading-[1.55]">District IT sets it up once · Admin sees the import log · Front office stops re-entering enrollment changes by hand</div>
          </div>
          <div className="bg-[#131726] border border-white/10 rounded-[1vw] p-[2vw]">
            <div className="text-[0.85vw] font-semibold tracking-widest text-[#7C6BF0] uppercase mb-[1vh]">How it works</div>
            <div className="text-[1.1vw] text-white/80 leading-[1.55]">SFTP drop or API pull · Field-level mapping per school · Diff preview before commit · Detailed log of inserts, updates, and skipped rows</div>
          </div>
        </div>
      </div>
    </div>
