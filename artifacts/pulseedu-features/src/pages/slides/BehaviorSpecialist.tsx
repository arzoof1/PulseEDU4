export default function BehaviorSpecialist() {
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-[#0C0F1A] text-white font-[Inter,sans-serif]">
      ...
      <div className="absolute top-[5vh] right-[5vw] flex items-center gap-[1vw]">
        ...
        <div className="text-[1vw] text-white/50">08 / 20</div>
      </div>

      <div className="relative z-10 h-full grid grid-cols-2 gap-[3vw] px-[7vw] py-[14vh] items-center">
        <div>
          <div className="text-[1vw] font-medium tracking-widest text-[#4F7FFF] uppercase mb-[1.5vh]">Module 06 · Behavior</div>
          <h1 className="text-[4.4vw] font-extrabold leading-[1] tracking-[-0.03em] mb-[3vh]">Behavior Specialist Workspace</h1>
          <p className="text-[1.5vw] font-light text-white/70 leading-[1.5] max-w-[35vw]">A focused workspace for the behavior team — caseload, behavior plans, and progress notes in one place.</p>
        </div>
        <div className="flex flex-col gap-[2vh]">
          <div className="bg-[#131726] border border-white/10 rounded-[1vw] p-[2vw]">
            ...
            <div className="text-[1.1vw] text-white/80 leading-[1.55]">A dashboard of every student on the specialist's caseload, with plan status, last contact, and open items needing attention.</div>
          </div>
          <div className="bg-[#131726] border border-white/10 rounded-[1vw] p-[2vw]">
            <div className="text-[0.85vw] font-semibold tracking-widest text-[#4F7FFF] uppercase mb-[1vh]">Who uses it</div>
            <div className="text-[1.1vw] text-white/80 leading-[1.55]">Behavior Specialist · Dean of students · Admin · Read-only view for the student's homeroom teacher</div>
          </div>
          <div className="bg-[#131726] border border-white/10 rounded-[1vw] p-[2vw]">
            <div className="text-[0.85vw] font-semibold tracking-widest text-[#4F7FFF] uppercase mb-[1vh]">How it works</div>
            <div className="text-[1.1vw] text-white/80 leading-[1.55]">Caseload assigned per specialist · Behavior plan with triggers and replacement behaviors · Session notes time-stamped on the student record</div>
          </div>
        </div>
      </div>
    </div>
