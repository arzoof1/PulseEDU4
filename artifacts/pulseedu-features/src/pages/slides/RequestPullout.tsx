export default function RequestPullout() {
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-[#0C0F1A] text-white font-[Inter,sans-serif]">
      ...
      <div className="absolute top-[5vh] right-[5vw] flex items-center gap-[1vw]">
        ...
        <div className="text-[1vw] text-white/50">19 / 20</div>
      </div>

      <div className="relative z-10 h-full grid grid-cols-2 gap-[3vw] px-[7vw] py-[14vh] items-center">
        <div>
          <div className="text-[1vw] font-medium tracking-widest text-[#7C6BF0] uppercase mb-[1.5vh]">Module 17 · Student support</div>
          <h1 className="text-[5vw] font-extrabold leading-[1] tracking-[-0.03em] mb-[3vh]">Request Pullout</h1>
          <p className="text-[1.5vw] font-light text-white/70 leading-[1.5] max-w-[35vw]">Teachers ask, support staff verify, admins approve — without anyone walking the request to the front office.</p>
        </div>
        <div className="flex flex-col gap-[2vh]">
          <div className="bg-[#131726] border border-white/10 rounded-[1vw] p-[2vw]">
            ...
            <div className="text-[1.1vw] text-white/80 leading-[1.55]">A teacher requests that a student be pulled for a counseling session, intervention, or check-in; the right staff get notified to confirm.</div>
          </div>
          <div className="bg-[#131726] border border-white/10 rounded-[1vw] p-[2vw]">
            <div className="text-[0.85vw] font-semibold tracking-widest text-[#7C6BF0] uppercase mb-[1vh]">Who uses it</div>
            <div className="text-[1.1vw] text-white/80 leading-[1.55]">Teachers (request) · Counselors / Specialists / MTSS (verify) · Admin (approve) · Front office (execute)</div>
          </div>
          <div className="bg-[#131726] border border-white/10 rounded-[1vw] p-[2vw]">
            <div className="text-[0.85vw] font-semibold tracking-widest text-[#7C6BF0] uppercase mb-[1vh]">How it works</div>
            <div className="text-[1.1vw] text-white/80 leading-[1.55]">Reason and proposed time on every request · Routed to the right verifier · Admin approval gate · Outcome logged on the student record</div>
          </div>
        </div>
      </div>
    </div>
